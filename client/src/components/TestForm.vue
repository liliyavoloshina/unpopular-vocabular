<template>
  <form action="#" @submit.prevent="onSubmit">
      ...
      <div class="columns is-centered">
        <div class="column is-half">
          <b-field label="Unpopular:">
            ...
            <b-input :value="currentWord.unpopular" type="text" readonly expanded />
          </b-field>
          ...
          <div v-if="isShowTip" class="mt-3">
            {{ currentWord.description }}
          </div>

          <div class="buttons mt-5">
            <b-button type="is-primary" expanded @click.prevent="onSubmit">
              Submit
            </b-button>
          </div>
        </div>
    ...
    <section v-else class="section is-medium is-size-5 has-text-centered mt-5">
      ...
      <b-button type="is-primary" class="mt-5" expanded @click.prevent="tryAgain">
        Try again?
      </b-button>
    </section>
  </form>
...
export default {
  ...
  methods: {
    onSubmit() {
      if (this.capitalizeFirstLetter(this.popular) === this.currentWord.popular) {
